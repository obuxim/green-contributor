    ...
    <main id="main">
        ...
        <section class="intro-block">
            <div class="slider fade-slider">
                <div>
                    <!-- intro block slide -->
                    <article class="intro-block-slide overlay bg-cover" style="background-image: url({{ asset('images/Slider/SLIDER-1.jpg') }});">
                ...
                <div>
                    <!-- intro block slide -->
                    <article class="intro-block-slide overlay bg-cover" style="background-image: url({{ asset('images/Slider/slider-2.jpg') }});">
                        <div class="align-wrap container">
                            <div class="align">
                                <div class="anim">
                ...
                <div>
                    <!-- intro block slide -->
                    <article class="intro-block-slide overlay bg-cover" style="background-image: url({{ asset('images/Slider/slider-3.jpg') }});">
                        <div class="align-wrap container">
                            <div class="align">
                                <div class="anim">
        ...
        <!-- counter aside -->
        <aside class="bg-cover counter-aside" style="background-image: url({{asset('images/large-banner.jpg')}});">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <article class="news-post">
                        ...
                        <h3><a href="blog-single.html">Video Title</a></h3>
                        <p>Video Description</p>
                        <time datetime="2011-01-12" class="time text-uppercase text-gray">Mar 05,2017  by <a href="blog-single.html">Uploader Name</a></time>
                    </article>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <!-- news post -->
        ...
        <section>
            <div class="video-container">
                <iframe width="420" height="315" src="https://www.youtube.com/embed/1gWmdSzDGCA?rel=0&modestbranding=1&showinfo=0" frameborder="0" allowfullscreen></iframe>
            </div>
        </section>
        <!-- large video section -->
        <section>
        ...
        <!-- testimonials block -->
        <section class="testimonials-block text-center bg-gray" style="background-image: url({{ asset('images/bg-pattern01.png') }});">
            <div class="container">
                <div class="row">
        ...
        <section class="popular-posts-block container">
            <header class="popular-posts-head">
                <h2 class="popular-head-heading">Products</h2>
            </header>
            <div class="row">
